...
apply_filters = st.sidebar.button('<span class="apply-text">Apply Filters</span>', unsafe_allow_html=True)

reset_filters = st.sidebar.button('<span class="reset-text">Reset Filters</span>', unsafe_allow_html=True)
